      ...
      <div className="flex items-center space-x-4">
        <div className="relative hidden md:block w-64">
          <input type="text" placeholder="Search for products..."
            className="w-full bg-gray-100 rounded-full py-2 px-4 text-sm" onChange={handleInputValue}/>
        ...
        <a href="#" className="hover:text-gray-500 transition-colors" ><span >{cart.length}</span>
